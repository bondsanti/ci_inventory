  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">จัดการ <small class="text-muted">ประเภทครุภัณฑ์</small></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
             ...
             <div class="col-md-7">
                ...
                <div class="card card-success">
                  <div class="card-header">
                    <h3 class="card-title">ฟอร์ม เพิ่มข้อมูล</h3>
                  </div>
                  <!-- /.card-header -->
                   <form role="form" action="<?php echo site_url('durable/insert_data_to_db');?>" method="post">
                  <div class="card-body">
                           ...
                           <div class="col-sm-3">
                            ...
                            <div class="col-sm-5">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="dur_code" placeholder="กรอก ประเภทครุภัณฑ์" required>
                              </div>
                            </div>
                              <div class="col-sm-4">
                             </div>
                           ...
                           <div class="col-sm-3">
                            ...
                            <div class="col-sm-5">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="dur_name" placeholder="กรอก ประเภทครุภัณฑ์" required>
                              </div>
                            </div>
                              <div class="col-sm-4">
                             </div>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                           ...
                           <p>ชื่อประเภทครุภัณฑ์<b><?php echo $rs->dur_name;?></b> หรือไม่?</p>
                          </div>
