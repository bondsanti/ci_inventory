                ...
                <div class="card-body">
                  <table id="example1" class="table table-hover table-striped projects">
                   ...
                   <?php  if ($rs->mat_req_statas == 1) { ?>
                     ...
                     <a class="btn btn-sm btn-success" href="<?php  echo site_url('material_approve_list/approve_data/').$rs->mat_req_id;?>"><i class="nav-icon fas fa-user-check"></i> การอนุมัติ</a>
                        


                        <a class="btn btn-sm btn-warning" href="<?php  echo site_url('material_approve_list/edit_data/').$rs->mat_req_id;?>"><i class="nav-icon fas fa-edit"></i> แก้ไขการเบิก</a>
                 ...
                 <a href="<?php  echo site_url('material_approve_list/approve_list_show/').$rs->mat_req_id;?>"  type="button" class="btn btn-success btn-sm">
                  <i class="fas fa-print"></i> พิมพ์เอกสาร</a>
                    <?php  }else{ ?>

                     <a class="btn btn-sm btn-success" href="<?php  echo site_url('material_approve_list/approve_list_show/').$rs->mat_req_id;?>"><i class="nav-icon fas fa-user-check"></i> การอนุมัติ</a>
                        


                        <a class="btn btn-sm btn-warning" href="<?php  echo site_url('material_approve_list/approve_list_show/').$rs->mat_req_id;?>"><i class="nav-icon fas fa-edit"></i> แก้ไขการเบิก</a>
