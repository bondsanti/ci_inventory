      ...
      <div class="container-fluid">
         ...
         <div class="row">
            ...
            <div class="card card-success">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form role="form" action="<?php echo site_url('position/insert_data_to_db');?>" method="post">
                   ...
                   <div class="col-sm-3">
                    ...
                    <div class="col-sm-5">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="posi_name" placeholder="กรอก ชื่อ ตำแหน่ง ในหน่วยงาน/แผนก" required>
                      </div>
                    </div>
                      <div class="col-sm-4">
                     </div>
