            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                ...
                <div class="card-header">
                        ...
                        <a href="<?php echo base_url('guarantee_report/year');?>" type="button" class="btn btn-success">รายงานเลือก <u><b>ปี</b></u></a>
                </div>
                 <form role="form" action="<?php echo base_url('Guarantee_report/search');?>" method="post"  id="form" enctype="multipart/form-data">
                <div class="card-body">
                                ...
                                <div class="col-sm-4">
                                  <div class="form-group">
                                    <label>ปีเริ่มต้น</label>
                                         <select class="form-control is-warning" name="yearStart" required>
                                ...
                                <div class="col-sm-4">
                                  <div class="form-group">
                                    <label>ปีสิ้นสุด</label>
                                     <select class="form-control is-warning" name="yearEnd" required>
