...
<table class="wrap-box line-top" cellpadding="0" cellspacing="0">
    <tr>  
        <td><table class="wrap-top" cellpadding="3" cellspacing="0">
                ...
                <tr>
                    <td style="width:35%;"><b><font size="10">รหัสพนักงาน:</b> <?php echo $code;?></font></td>
                    <td style="width:40%;"><b><font size="10">ชื่อหน่วยงาน:</b> <?php echo $gov;?></font></td>
                    <td style="width:35%;"><b><font size="10">รหัสพนักงาน:</b> <?php echo $code1;?></font></td>
                </tr>
                <tr>
                    <td style="width:35%;"><b><font size="10">ชื่อ-สกุล:</b> <?php echo $name;?></font></td>
                    <td style="width:40%;"><b><font size="10">แผนก:</b> <?php echo $dep;?></font></td>
                    <td style="width:35%;"><b><font size="10">ชื่อ-สกุล:</b> <?php echo $name1;?></font></td>
                </tr>
            </table>
        </td>
    </tr>
...
<table width="100%" border="0">
  <tr>
    <td width="33%" align="center" valign="middle">ลงชื่อ........................................</td>
    <td width="33%" align="center" valign="middle">ลงชื่อ........................................</td>
    <td width="33%" align="center" valign="middle">ลงชื่อ........................................</td>
  </tr>
  <tr>
    <td width="33%" align="center" valign="middle">( <?php echo $name2;?> )</td>
    <td width="33%" align="center" valign="middle">( <?php echo $name1;?> )</td>
    <td width="33%" align="center" valign="middle">( <?php echo $name;?> )</td>
  </tr>
  <tr>
    <td width="33%" align="center" valign="middle">ผู้อนุมัติ</td>
    <td width="33%" align="center" valign="middle">ผู้บันทึก</td>
    <td width="33%" align="center" valign="middle">ผู้เบิก</td>
  </tr>
</table>
