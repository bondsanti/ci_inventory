      ...
      <div class="container-fluid">
         ...
         <div class="row">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form role="form" action="<?php echo site_url('member/update_data_to_db');?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control text-danger" name="member_gov" autocomplete="off" value="<?php echo $Query_edit->member_gov;?>" placeholder="กรอก ชื่อหน่วยงาน/บริษัท" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>ชื่อ แผนกในหน่วยงาน/บริษัท</label>
                        <input type="text" class="form-control text-danger" name="member_dep" autocomplete="off" value="<?php echo $Query_edit->member_dep;?>" placeholder="กรอก ชื่อแผนกในหน่วยงาน/บริษัท" required>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control text-danger" name="mem_code" autocomplete="off" value="<?php echo $Query_edit->mem_code;?>" placeholder="กรอก รหัสประจำตัว พนักงาน" required>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label>ชื่อ</label>
                        <input type="text" class="form-control text-danger" name="mem_fname" autocomplete="off" value="<?php echo $Query_edit->mem_fname;?>" placeholder="กรอก ชื่อ" required>
                      </div>
                    </div>
                     <div class="col-sm-3">
                      <div class="form-group">
                        <label>นามสกุล</label>
                        <input type="text" class="form-control text-danger" name="mem_lname" autocomplete="off" value="<?php echo $Query_edit->mem_lname;?>"  placeholder="กรอก นามสกุล" required>
                      </div>
                    </div>
                  </div>
                   ...
                   <div class="row">
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control text-danger" name="mem_tel" autocomplete="off" maxlength="10" value="<?php echo $Query_edit->mem_tel;?>" placeholder="กรอก เบอร์โทรศัพท์" required>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control text-danger" name="mem_email" autocomplete="off" value="<?php echo $Query_edit->mem_email;?>" placeholder="กรอก Email" required>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label class="text-danger">*Username</label>
                        <input type="text" class="form-control text-danger" name="mem_username" autocomplete="off" value="<?php echo $Query_edit->mem_username;?>" placeholder="กรอก Username" required>
                      </div>
                    </div>
                     <div class="col-sm-3">
                      <div class="form-group">
                        <label class="text-danger">*Password</label>
                        <input type="password" class="form-control text-danger" name="mem_password" autocomplete="off" value="<?php echo $Query_edit->mem_password;?>" placeholder="กรอก Password" disabled>
                      </div>
                    </div>
                  </div>
