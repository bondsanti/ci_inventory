            ...
            <div class="col-md-12">
              ...
              <td>
                      ...
                      <td class="text-center">
                       ...
                       <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#ModalDel<?php echo $rs->mem_id;?>">
                ...
                <!-- Modal Del -->
                    <div class="modal fade" id="ModalDel<?php echo $rs->mem_id;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
