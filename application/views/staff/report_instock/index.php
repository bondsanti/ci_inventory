  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">รายงาน <small class="text-muted">รับเข้าวัสดุ</small></h1>
          </div><!-- /.col -->
            ...
            <div class="col-md-6">
              <div class="card card-primary">
                ...
                <div class="card-header">
                 ...
                 <form role="form" action="<?php echo base_url('report_instock/search');?>" method="post"  id="form" enctype="multipart/form-data">
                <div class="card-body">
