            ...
            <div class="col-md-8">
              <div class="card card-lightblue">
               ...
               $stock='<font color="green"><b>'.$rs->mat_reg_qty_stock.'</b></font> '.$rs->u_name;
                    ...
                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#ModalPickup<?php echo $rs->mat_reg_id;?>">
                   ...
                   <?php  }
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="ModalPickup<?php echo $rs->mat_reg_id;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
