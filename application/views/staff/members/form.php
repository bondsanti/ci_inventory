  <!-- Modal Add -->
                        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              <form role="form" action="<?php echo base_url('members/insert_data');?>" method="post"  id="form" enctype="multipart/form-data">
                 ...
                 <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mem_code" value="<?php echo set_value('mem_code'); ?>" placeholder="กรอก รหัสประจำตัว" autocomplete="off" required>
                      </div>
                  ...
                  <input type="hidden" class="form-control text-danger" name="lev_id" autocomplete="off" value="6" required>
