  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">รายการที่คุณ <small class="text-muted">อนุมัติ การเบิก-จ่าย</small></h1>
          </div><!-- /.col -->
           <div class="col-sm-6">
         ...
         <div class="row">
            ...
            <div class="col-md-12">
               ...
               <div class="callout callout-info">
                  ...
                  <p>จะแสดงข้อมูลเฉพาะที่คุณทำรายการรอนุมัติ-เบิกจ่าย</p>
                </div>
                  ...
                  <table id="example1" class="table table-hover table-striped projects">
                    ...
                    <tbody>
                     ...
                     foreach ($Query as $rs) 
                      ...
                      <td><?php echo $rs->sex2.' '.$rs->fname2.' '.$rs->lname2;?></td>
