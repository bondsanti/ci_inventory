...
<h4>สถานะ <?php echo $status;?></h4>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;( &nbsp; &nbsp;&nbsp; <?php echo $name;?> &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;)
             ...
             <a href="<?php  echo site_url('material_approve_list/printpdf/').$mat_req_id;?>" target="_blank"  type="button" class="btn btn-success"><i class="fas fa-print"></i> พิมพ์
                    </a>

                 <a href="<?php  echo site_url('material_approve_list');?>" type="button" class="btn btn-primary"><i class="fas fa-redo-alt"></i> กลับ
                    </a>
                </div>
