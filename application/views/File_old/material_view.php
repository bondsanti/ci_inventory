          ...
          <div class="row">
             ...
             <div class="col-md-7">
                ...
                <div class="card card-success">
                  ...
                  <!-- /.card-header -->
                   <form role="form" action="<?php echo site_url('material/insert_data_to_db');?>" method="post">
                  <div class="card-body">
                           ...
                           <div class="col-sm-3">
                            ...
                            <div class="col-sm-5">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mat_code" placeholder="กรอก รหัสประเภท" required>
                              </div>
                            </div>
                              <div class="col-sm-4">
                             </div>
                           ...
                           <div class="col-sm-3">
                            ...
                            <div class="col-sm-5">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mat_name" placeholder="กรอก ชื่อประเภท" required>
                              </div>
                            </div>
                              <div class="col-sm-4">
                             </div>
